...
fn build_found_report(root: PathBuf, candidates: Vec<PathBuf>) -> ReadinessReport {
    ...
    let items = vec![
        ...
        item(
            "rasterrelay-nodes",
            "RasterRelay nodes",
            Some(&custom_nodes_path),
            "brak",
            "Stare custom nodes RasterRelay zostaly usuniete. Nowe podejscie powstanie podczas przebudowy.",
            None,
            false,
        ),
    ];
    ...
    ReadinessReport {
        ...
        summary: "Znaleziono ComfyUI. Stary workflow i stare custom nodes RasterRelay sa wyczyszczone."
            .to_string(),
        counts: ReadinessCounts {
            custom_nodes,
            loras,
